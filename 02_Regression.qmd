...
This dat frame has a bunch of coefficients for the slope and intercept of the relationship between each phylum and temperature. We kind of don't care about the intercepts though, and the p values are hard to read as wrritten.
